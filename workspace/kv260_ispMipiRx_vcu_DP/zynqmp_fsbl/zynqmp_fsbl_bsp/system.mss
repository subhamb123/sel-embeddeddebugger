...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = audio_ss_0_audio_formatter_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = i2srx
 PARAMETER DRIVER_VER = 2.2
 PARAMETER HW_INSTANCE = audio_ss_0_i2s_receiver_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = i2stx
 PARAMETER DRIVER_VER = 2.2
 PARAMETER HW_INSTANCE = audio_ss_0_i2s_transmitter_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_vip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipicsiss
 PARAMETER DRIVER_VER = 1.9
 PARAMETER HW_INSTANCE = capture_pipeline_mipi_csi2_rx_subsyst_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = capture_pipeline_v_frmbuf_wr_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = vcu_vcu_0
END
